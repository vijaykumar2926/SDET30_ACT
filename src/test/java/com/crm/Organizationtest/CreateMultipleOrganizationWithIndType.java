...
public class CreateMultipleOrganizationWithIndType extends BaseClass 
{
		@Test(dataProvider = "testdata")
	public void createOrgWithIndType(String OrgName,String IndType) throws Throwable
	{
		// random number
	...
	{
		Object[][] data = eLib.readMultipleDataFromExcel("Orgdata");
		return data;
	}
}
