...
public class CreateContactReferanceTest extends BaseClass //TC_24
{
	@Test
	public void CreateContactReferance() throws Throwable
	{
		...
		ccp.getReferenceCheckbox().click();
