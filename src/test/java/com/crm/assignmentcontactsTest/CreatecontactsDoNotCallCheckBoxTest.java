...
public class CreatecontactsDoNotCallCheckBoxTest extends BaseClass  //TC_22
{
	@Test
	public void CreatecontactsDoNotCallCheckBox() throws Throwable
	{
		...
		ccp.getDoNotCallCheckbox().click();
